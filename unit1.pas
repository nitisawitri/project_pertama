...
begin
 ComboBoxmakanan.Clear;
 Edithargamakanan.Clear;
 Editjumlahmakanan.Clear;
 ComboBoxminuman.Clear;
 Edithargaminuman.Clear;
 Editjumlahminuman.Clear;
 Edittotalbayar.Clear;
 Editbayar.Clear;
 Editkembali.Clear;
